...
public class FailFrameCaptureFilter extends OncePerRequestFilter {
    ...
    public FailFrameCaptureFilter(
        ...
        this.failFrameClient = failFrameClient;
    ...
    private void maybeCapture(
        ...
        FailFrameEvent event = new FailFrameEvent(
